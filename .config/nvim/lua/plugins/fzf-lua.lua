return {
  ...
  config = function(_, opts)
    ...
    map_with_cursor_restore('n', '<leader>ttg', fzf.files, { cwd = '/Volumes/dev/_tasks/gtm' }, '[Fzf] Search GTM tasks')
    map_with_cursor_restore('n', '<leader>ttm', fzf.files, { cwd = '/Volumes/dev/_tasks', raw_cmd = 'rg --files my_*' }, '[Fzf] Search My tasks')
