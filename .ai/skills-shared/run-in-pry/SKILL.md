...
```text
$DEV_ROOT/projects/shaka/gtm/1st/
$DEV_ROOT/projects/shaka/gtm/2nd/
$DEV_ROOT/projects/shaka/gtm/3rd/
```
...
```bash
cd $DEV_ROOT/projects/shaka/gtm/1st && set -a && source hermes-skills/.env && set +a && pry <<'RUBY'
require './config/boot'
